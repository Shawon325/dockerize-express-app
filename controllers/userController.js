...
module.exports.index = async (request, response) => {
  try {
    ...
    return response.status(200).send(success(users, 'Users fetched successfully'));
  } catch (exception) {
...
module.exports.edit = async (request, response) => {
  ...
  return response.status(200).send(success(user, 'User fetched successfully'));
};
...
module.exports.destroy = async (request, response) => {
  ...
  return response.status(200).send(success([], 'User deleted successfully'));
};
